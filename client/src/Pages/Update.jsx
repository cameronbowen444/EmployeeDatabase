  ...
  const getMember = async () => {
    try {
      ...
      setForm({
        ...
        phone: res.data.phone ? formatPhone(res.data.phone) : "",
        position: res.data.position || "",
        department: res.data.department || "",
        salary: res.data.salary ? formatSalary(String(res.data.salary)) : "",
      ...
      setAlert({
        ...
        message:
          ...
          "Could not load this employee. Please try again.",
      });
    } finally {
      setIsLoading(false);
    }
  ...
  const updateMember = async () => {
    ...
    try {
      ...
      setAlert({
        ...
        message:
          err.response?.data?.message ||
          "Could not update employee. Please check the form.",
      });
  ...
  if (isLoading) {
    return (
      <LoadingState
        ...
        message="Fetching this protected employee record."
      />
    );
  }
    ...
    <div className="mx-auto max-w-3xl">
      ...
      <div className="rounded-3xl border border-white/10 bg-white/5 p-5 shadow-xl">
        <div className="mb-5">
          ...
          <h2 className="mt-1 text-xl font-black text-white">Update Record</h2>

          <p className="mt-2 text-sm leading-6 text-slate-400">
            Make changes to this employee profile.
          </p>
        </div>
        ...
        <form onSubmit={openConfirm} className="space-y-4">
          ...
          <div className="flex flex-col-reverse gap-3 pt-2 sm:flex-row sm:justify-end">
            ...
            <button
              ...
              className="rounded-xl bg-emerald-400 px-4 py-2 text-sm font-black text-slate-950 transition hover:bg-emerald-300 disabled:cursor-not-allowed disabled:opacity-60"
            >
              Update Employee
            </button>
          </div>
      ...
      <ConfirmModal
        isOpen={showConfirm}
        title="Update this employee?"
        message={`Save changes for ${form.firstName} ${form.lastName}?`}
